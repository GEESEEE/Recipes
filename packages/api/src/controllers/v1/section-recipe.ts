...
export default class SectionRecipeController implements interfaces.Controller {
    ...
    @httpGet(
        ...
        ...SectionRecipeController.validate('getRecipesBySectionId'),
    ...
    @httpPost(
        '/bulk',
        TYPES.PassportMiddleware,
        ...SectionRecipeController.validate('createRecipes'),
        TYPES.ErrorMiddleware
    )
    ...
    @httpPut(
        '/bulk',
        TYPES.PassportMiddleware,
        ...SectionRecipeController.validate('updateRecipes'),
        TYPES.ErrorMiddleware
    )
    ...
    @httpDelete(
        '/:recipeId',
        TYPES.PassportMiddleware,
        ...SectionRecipeController.validate('deleteRecipe'),
        TYPES.ErrorMiddleware
    )
