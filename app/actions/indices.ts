...
export const retrieveIndices = () => async (dispatch: Dispatch): Promise<void> => {
    try {
...
export const decrementIngredientId =
    ...
    async (dispatch: Dispatch): Promise<void> => {
        try {
            ...
            await AsyncStorage.setItem('ingredientId', JSON.stringify(ingredientId))
        } catch (err) {
            console.error(err)
        }
    }
...
export const decrementInstructionId =
    ...
    async (dispatch: Dispatch): Promise<void> => {
        try {
            ...
            await AsyncStorage.setItem('instructionId', JSON.stringify(instructionId))
        } catch (err) {
            console.error(err)
        }
    }
