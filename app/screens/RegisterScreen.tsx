...
const UsernameInputField = ({ onChangeText } : { onChangeText: (text: string) => void}): JSX.Element => {
  return (
...
const EmailInputField = ({ onChangeText } : { onChangeText: (text: string) => void}): JSX.Element => {
  return (
    <View style={globalStyles.userinput}>
      <TextInput
        placeholder="E-mail"
...
const PasswordInputField = ({secureTextEntry, onChangeText, onEyePress} : {secureTextEntry: boolean, onChangeText: (text: string) => void, onEyePress: () => void}): JSX.Element =>{
  return (
    <View style={{ ...globalStyles.userinput }}>
      <TextInput
